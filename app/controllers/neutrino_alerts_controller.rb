class NeutrinoAlertsController < ApplicationController
  ...
  private
    ...
    def neutrino_alert_params
      params.require(:neutrino_alert).permit(:name, :date, :ra, :dec, :signalness, :energy,:noticetype, :radius90, :radius50, :url, :type, :time, :source_ids,:numrfc,:circular_neutrino_ids,:sky_plot)
    end
end
